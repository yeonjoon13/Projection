...
const Card: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div
    className="bg-white rounded-lg shadow-sm p-4 mb-4 border-2 flex items-center justify-center"
...
const BarChart: React.FC<BarChartProps> = ({ label, value, unit, ranges }) => {
  const colorRange = [
